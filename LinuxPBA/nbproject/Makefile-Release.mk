...
${OBJECTDIR}/_ext/7daaf93a/DtaDevRuby1.o: ../Common/DtaDevRuby1.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/7daaf93a
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../linux -I../Common -I../Common/pbkdf2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7daaf93a/DtaDevRuby1.o ../Common/DtaDevRuby1.cpp
...
${OBJECTDIR}/_ext/b7b9df0c/sha512.o: ../Common/pbkdf2/sha512.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/b7b9df0c
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -I../linux -I../Common -I../Common/pbdkf2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b7b9df0c/sha512.o ../Common/pbkdf2/sha512.c
